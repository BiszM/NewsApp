...
public class FragmentLaptop extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    View view;
        ...
        if (networkInfo != null){
            ...
            if(isRetry){
                ...
                if(isRefreshing){
                    ...
                    checkModel = NewsModel.getNewsDetails("laptop");
