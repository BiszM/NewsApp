package com.example.prith.technews.fragments.navBar;
...
public class FragmentBike extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    View view;
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_bike, container, false);
        ...
        if (networkInfo != null){
            ...
            if(isRetry){
                ...
                if(isRefreshing){
                    ...
                    checkModel = NewsModel.getNewsDetails("bike");
    ...
    public void callFirebaseData(){
        ...
        firebaseConnection.getNews("bike");
        firebaseConnection.setDataListener(new DataListener() {
            @Override
            public void onDataReceived(boolean flag) {
                checkModel2 = NewsModel.getNewsDetails("bike");
                adapter = new MyAdapter(getContext(), checkModel2);
                recyclerView.setAdapter(adapter);
            }
        });
    }
